...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='spade_colorization', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--same_input', action='store_true', help='target == ref')
        parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')
        parser.add_argument('--top_n_reference', type=int, default=1, help='chose reference from top-n nearest')

        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/DATA1/hksong/imagenet/')
        parser.add_argument('--dataset_mode', type=str, default='affin')
    ...
    def parse(self, save=False):
        ...
        # the number of channels in tgt_value = 256
        opt.semantic_nc = 256
